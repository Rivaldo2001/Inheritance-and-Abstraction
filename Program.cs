...
namespace School
{
    class Program
    {
        static void Main()
        {
            ...
            {
                new Student("Rivaldo", 640927, "excellent at hystory"),
                new Student("maulana", 645820),
                new Student("putra", 340981, "very badly behave yourself")
            };
            Student Fauzi = new Student("Fauzi", 123456, "very good at math");
            Student Abdullah = new Student("Abdullah", 356272);
            myStudents.Add(Fauzi);
            myStudents.Add(Abdullah);
